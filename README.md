...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-shape-4fb2
```

A live public deployment of this template is available at [https://royal-shape-4fb2.templates.workers.dev](https://royal-shape-4fb2.templates.workers.dev)
